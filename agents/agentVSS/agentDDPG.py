...
class AgentDDPG:
    ...
    def __init__(self, name='DDPG',
                 maxEpisodes=10000, maxSteps=2000, batchSize=512, replayBufferSize=200000, valueLR=1e-3, policyLR=1e-4,
                 hiddenDim=256, nEpisodesPerCheckpoint=50):
        # Training Parameters
        ...
        self.env = NormalizedWrapper(gym.make("rSimVSS3v3-v0"))
        ...
        actionDim = self.env.action_space.shape[1] #TODO: esta uma gambiarra pois o action_shape tem duas dimensoes
    ...
    def train(self):
        while self.nEpisodes < self.maxEpisodes:
            ...
            print("Episode number:", self.nEpisodes)
