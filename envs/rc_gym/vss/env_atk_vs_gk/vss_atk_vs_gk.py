...
from rc_gym.vss.env_atk_vs_gk.goalkeeper.models import DDPGActor


class VSSAtkVsGkEnv(VSSBaseEnv):
    ...
    def load_gk(self):
        ...
        gk_path = os.path.dirname(os.path.realpath(
            __file__)) + '/goalkeeper/gk_model.pth'
    ...
    def _get_commands(self, actions):
        ...
        gk_action = self.goalkeeper.get_action(self._gk_obs())
        # we invert the speed on the wheels because of the goalkeeper's reflection on the Y axis.
        commands.append(Robot(yellow=True, id=0, v_wheel1=gk_action[1],
                        v_wheel2=gk_action[0]))
