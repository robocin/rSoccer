...
def print_with_description(state):
    print("Time = {}".format(state[0]))
    print("Ball X = {}".format(state[1]))
    print("Ball Y = {}".format(state[2]))
    print("Ball Vx ={:.2f}".format(state[3]))
    print("Ball Vy ={:.2f}".format(state[4]))
    print("id 0 Blue Robot target_x = {:.2f}".format(state[5]))
    print("id 0 Blue Robot target_y = {:.2f}".format(state[6]))
    print("id 0 Blue Robot X = {}".format(state[7]))
    print("id 0 Blue Robot Y = {}".format(state[8]))
    print("id 0 Blue Robot sin(theta) = {:.2f}".format(state[9]))
    print("id 0 Blue Robot cos(theta) = {:.2f}".format(state[10]))
    print("id 0 Blue Robot Vx =     {:.2f}".format(state[11]))
    print("id 0 Blue Robot Vy =     {:.2f}".format(state[12]))
    print("id 0 Blue Robot v_theta ={:.2f}".format(state[13]))
