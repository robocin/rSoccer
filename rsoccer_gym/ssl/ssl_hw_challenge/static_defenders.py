...
class SSLHWStaticDefendersEnv(SSLBaseEnv):
    ...
    def __init__(self, field_type=2, render_mode=None):
        super().__init__(
    ...
    def _get_commands(self, actions):
        ...
        cmd = Robot(
            ...
            v_y=v_y,
            v_theta=v_theta,
            kick_v_x=self.kick_speed_x if actions[3] > 0 else 0.0,
    ...
    def _calculate_reward_and_done(self):
        ...
        # Check ball for ending conditions
            ...
            reward = reward + ball_dist_rw + ball_grad_rw + energy_rw
    ...
    def __ball_grad_rw(self):
        ...
        # Goal pos
        goal = np.array([self.field.length / 2, 0.0])
